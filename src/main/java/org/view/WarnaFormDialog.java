...
public class WarnaFormDialog extends JDialog {
    ...
    public WarnaFormDialog(Frame owner, Warna warna) {
        super(owner, true);
        this.warna = warna;
        ...
        if (warna != null) {
            ...
            btnSimpan.setText("Update Warna");
        } else {
    ...
    private void initComponents() {
        ...
        JLabel lblTitle = new JLabel(warna == null ? "Tambah Warna Baru" : "Update Data Warna");
        ...
        JLabel lblNama = new JLabel("Nama Warna (misal: Merah, Navy, dll)");
        ...
        txtNama.putClientProperty(FlatClientProperties.PLACEHOLDER_TEXT, "Masukkan nama warna...");
    ...
    private void handleAction() {
        ...
        if (nama.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Nama warna tidak boleh kosong!", "Peringatan", JOptionPane.WARNING_MESSAGE);
            return;
        }

        if (warna == null) {
            warna = new Warna();
            warna.setNamaWarna(nama);
            if (warnaDAO.insert(warna)) {
                isSuccess = true;
                dispose();
            }
        } else {
            warna.setNamaWarna(nama);
            if (warnaDAO.update(warna)) {
                isSuccess = true;
                dispose();
            }
        }
