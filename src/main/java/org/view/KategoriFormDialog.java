...
public class KategoriFormDialog extends JDialog {
    ...
    public KategoriFormDialog(Frame owner, Kategori kategori) {
        super(owner, true);
        ...
        if (kategori != null) {
            ...
            btnSimpan.setText("Update Kategori");
        } else {
    ...
    private void initComponents() {
        ...
        JLabel lblTitle = new JLabel(kategori == null ? "Tambah Kategori Baru" : "Update Data Kategori");
